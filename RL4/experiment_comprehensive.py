...
if __name__ == "__main__":
    ...
    #qlearning(num_iter1=1000, alpha=0.4, epsilon=0.4);
    #qlearning(num_iter1=1000, alpha=0.4, epsilon=1.0);
    qlearning(num_iter1=20, alpha=0.4, epsilon=1.0);
    qlearning(num_iter1=20, alpha=0.6, epsilon=1.0);
    qlearning(num_iter1=20, alpha=1.0, epsilon=1.0);
